            ...
            <div slot="content">
                <div v-if="orderList.length">
                    <div v-for="(item, i) in orderList" :key="i">
                        <div class="gray-sub-title cart-title">
                            <div class="first">
                                <div>
                                    ...
                                    <span class="order-id">订单号： <a href="javascript:;">1234556778</a></span>
                                </div>
                                <div class="f-bc">
                        ...
                        <div class="pr">
                            <div class="cart" v-for="(good, j) in item.goodList" :key="j">
                                <div class="cart-l">
                                    <div class="cart-l-l">
                                        <div class="img-box">
                                            <img src="/static/images/logo.png">
                                        </div>
                                        <div class="ellipsis">商品名称</div>
                                    </div>
                                    <div class="cart-l-r">
                                        <div>¥ 12</div>
                                        <div class="num">1</div>
                                        <div class="type">
                                            <a class="del-order">删除此订单</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="cart-r">
                            ...
                            <div class="prod-operation pa" style="right: 0;top: 0;">
                                ...
                                <div class="status"> {{'1' === '1' ? '已支付' : '已关闭'}}  </div>
                            </div>
                        </div>
                    </div>
                </div>
